...
char i, details[20], name[20], email[20], mobile[20], doctor[20], address[30], entry[10], out[10];
int admin()
{
	char ch;
     do{
...
int pay()
{
	...
	printf("                   Your nearest hostpital is Ganesh Meridian               \n");
...
{
	int scm, a, b, c;
	printf("\na. ==> If you want an emergency, you should pay Rs.1200 per visit.\n");
	printf("b. ==> If you want to normal checkup for some days, you should pay Rs.200 per checkup.\n");
	printf("c. ==> If you want to get express services, you should pay Rs.2000 per hour.\n");
	printf("\nTell us your choice : ");
	scanf("%d",&scm);
	pay();
}
...
int main()
{
	...
	printf("**\n");
	printf("\n                                  PID - 112                                     \n");
	printf("                          Gujarat Directory                         \n");
	printf("                          Developed by : Jyot Sheth                         \n");
	printf("                            For the Academic Year :                           \n");
	printf("                               2022-2023                                   \n");
	printf("                            Branch : CSE                           \n");
	printf("                             Enrollment No. : CSE07                            \n");
	printf("\n**\n");
	printf("==============================================================================\n");
	login(&x,&y);
	return 0;
